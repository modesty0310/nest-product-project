...
export class ProductService {
    ...
    async findAll() {
        return await this.productRepository.find({relations: ["productSaleslocation"]});
    }

    async findOne({productId}) {
        return await this.productRepository.findOne({where: {id:productId}, relations: ["productSaleslocation"]});
    }
